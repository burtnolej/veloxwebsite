          ...
          <div class="container">
            <div class="row mb-4">
              <div class="col-12 p-0 position-relative">
                <img class="header-image" src="articles/supply_and_demand_repost/Final_Website.png" alt="">
              </div>
            </div>
          </div>
        </section>
                ...
                <div class="container">
                  <div class="row py-5">
                    <div class="col-12 col-lg-10 position-relative mx-auto bg-white">
                      ...
                      the front office business demand for technological innovation, such as new systems and 
                      upgrades and the ability of the front office technology department to supply it, quickly and affordably.
                      </p>
                      <p>
                      There are many factors that drove this; good, bad, technical and non-technical but 
                      certainly the ability of a software system (or systems) to adapt was always a factor.
                      </p>
                      <p>
                      Below I have listed what I think are the top 6 factors that slowed our ability to innovate: </p>
                      <p>
                      <h3>Getting the right data into the right state to be useful and actionable.</h2> </p>
                      <p>
                      ...
                      <p>
                      Even to this day, most production systems employ a traditional client server architecture 
                      with a thick client (UI) locally installed on the desktop, often managed by a separate team. 
                      Keeping the UI performant, dealing with complexity of spreading business logic across 
                      client and server and different teams invariably created friction.</p>
                                                                        
                      <p><h3>Corralling a mixture of in-house and 3rd party technologies</h3></p>
