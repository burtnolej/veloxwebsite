                    ...
                    <div class="container">
                        <div class="row d-flex justify-content-between">
                            ...
                            <div class="col d-flex justify-content-end align-items-center">
                                ...
                                <a href="https://www.linkedin.com/company/veloxfintech/" target="_blank" rel="nofollow">
                                    <img class="icon-linkedin" src="assets/linkedin.svg" alt="Velox linked" />
                                </a>
                            </div>
                        </div>
                    </div>
                ...
                <form id="contact-form" action="send/send.php" method="POST" class="needs-validation" novalidate>
                  ...
                  <div class="mb-5 smallprint">
                    * Required field
                    ...
                    <br/>
                    <br/>
                    For further details, please read our <a href="https://www.veloxfintech.com/privacy/">Privacy Policy</a>.
                  </div>
        ...
        function afterCaptchaError() {
          document.getElementById("modal-body").innerHTML = "Please send an e-mail directly to <a href='mailto:info@veloxfintech.com'>info@veloxfintech.com</a>. Unfortunately we couldn't confirm your bot-status.";
        }

        function afterSend() {
          document.getElementById("modal-body").innerHTML = "Thank you very much for your interest in velox. We will contact you shortly.<br/><br/>Kind regards,<br/>The velox team";
        }
        </script>
    </body>
</html>
